function triangleCheck() {
  ...
  var AB =
    parseInt(document.trianleSides.A.value) +
    parseInt(document.trianleSides.B.value);
  var AC =
    parseInt(document.trianleSides.A.value) +
    parseInt(document.trianleSides.C.value);
  var BC =
    parseInt(document.trianleSides.B.value) +
    parseInt(document.trianleSides.C.value);
  ...
  var txts = [
    ...
    "THIS IS ISOSCELENES TRIANGLE",
    "THIS IS SCALENE TRIANGLE",
    "CAN NOT FORM A TRIANGLE",
    "THIS IS NOT VALID NUMBERS"
  ];
  var out;
